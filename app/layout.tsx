...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Result dates / calendar — primary head terms
  ...
  openGraph: {
    ...
    locale: "en_IN"
    // OG image is generated by app/opengraph-image.tsx and automatically
    // attached by Next.js. Per-page metadata can override .images directly.
  },
  twitter: {
  ...
  // hreflang — declares the canonical Indian-English version of every URL.
  // Single locale for now; future translations would add x-default + en-US.
  alternates: {
    languages: {
      "en-IN": "/"
    }
